...
#CALCOLO TEMPO PLI
    ...
    # t = time.time()
    m, total_pli = resolver.solve_model(resolver.pli_implementation(10, [12,35,47,21,16,46,20,4,11,23], [[8,7],[6,1],[1,4]], 0)[0])
    # total = time.time() - t
...
if __name__ == "__main__":
    main()
    #resolver.pli_implementation(10, [12,35,47,21,16,46,20,4,11,23], [[8,7],[6,1],[1,4]], 0)
